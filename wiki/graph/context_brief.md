...
- [weakly_supported] Self-distilled experience principles outperform external-teacher distillation once the agent's base model crosses a capacity threshold (conf: 0.45)
- [weakly_supported] A single LLM with well-crafted prompts can match complex multi-agent debate frameworks on reasoning benchmarks (conf: 0.55)
- [supported] Skill marketplaces expose LLM agents to a distinctive supply-chain attack surface (conf: 0.8)
- [weakly_supported] State-of-the-art LLM agents fail at combined deep + wi
## Open Gaps
...
## Recent Relationships (42 total)
  papers/sok-agentic-skills-beyond-tool-use --introduces_concept--> concepts/skill-marketplace-supply-chain-risk
  papers/sok-agentic-skills-beyond-tool-use --supports--> claims/curated-skills-outperform-self-generated
  papers/sok-agentic-skills-beyond-tool-use --supports--> claims/skill-marketplaces-expose-supply-chain-risk
  papers/evotool-self-evolving-tool-use-policy --introduces_concept--> concepts/trajectory-grounded-blame-attribution
  papers/evotool-self-evolving-tool-use-policy --introduces_concept--> concepts/modular-tool-use-policy
  papers/evotool-self-evolving-tool-use-policy --introduces_concept--> concepts/diversity-aware-population-selection
  papers/evotool-self-evolving-tool-use-policy --supports--> claims/module-level-blame-attribution-enables-stable
  papers/evotool-self-evolving-tool-use-policy --supports--> claims/diversity-aware-population-selection-prevents-premature
  papers/learning-job-experience-driven-self-evolving --introduces_concept--> concepts/hierarch
