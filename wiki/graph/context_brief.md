...
## Claims (21 total)
- [weakly_supported] Gradient-free experience-library learning can match or exceed gradient-based parameter tuning on agentic reasoning benchmarks (conf: 0.5)
...
- [weakly_supported] Graph-structured skill retrieval outperforms flat skill libraries on compositional tasks (conf: 0.72)
...
- [weakly_supported] Population broadcast improves over isolated Reflexion in all tested model-representation conditions (conf: 0.65)
- [weakly_supported] Recurrent Bi-Level GRPO Skill Evolution Outperforms Vanilla GRPO on Multi-Step Agent Tasks (conf
## Open Gaps
...
- [3] FORGE: Self-Evolving Agent Memory With No Weight Updates via Population Broadcast (NLP)
...
- [3] SkillGraph: Skill-Augmented Reinforcement Learning for Agents via Evolving Skill Graphs (NLP)
...
## Recent Relationships (80 total)
  papers/skill-r1-agent-skill-evolution-reinforcement --builds_on--> papers/sok-agentic-skills-beyond-tool-use
  papers/evotool-self-evolving-tool-use-policy --similar_method_to--> papers/skill-r1-agent-skill-evolution-reinforcement
  papers/skill-r1-agent-skill-evolution-reinforcement --supports--> claims/recurrent-skill-evolution-bilevel-grpo-outperforms-vanilla-grpo
  papers/skillgen-verified-inference-time-agent-skill --uses_concept--> concepts/skill-lifecycle
  papers/skillgen-verified-inference-time-agent-skill --introduces_concept--> concepts/contrastive-induction-skill-synthesis
  papers/skillgen-verified-inference-time-agent-skill --introduces_concept--> concepts/skill-intervention-verification
  papers/skillgen-verified-inference-time-agent-skill --extends_concept--> concepts/trajectory-grounded-blame-attribution
  papers/skillgen-verified-inference-time-agent-skill --complementary_to--> papers/skillos-learning-skill-curation-self-evolving
  papers/skill-r1-agent-skill-evolut
