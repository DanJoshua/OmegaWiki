...
\toprule
\multirow{2}{*}{Model} & \multirow{2}{*}{Method} & \multicolumn{6}{c}{Exact Match $\uparrow$} & \multicolumn{1}{c}{API / Acc. $\uparrow$}\\
\cmidrule(lr){3-8}\cmidrule(lr){9-9}
 &  & AIME24 & AIME25 & GPQA & MMLU-Pro (Eco) & MMLU-Pro (Eng) & MMLU-Pro (Philo) & ToolBench& \multicolumn{1}{c}{Avg $\uparrow$}\\
\midrule
...
\bottomrule
\end{tabular}}
\caption{Cross-dataset results of diverse memory architectures across models on the single-turn reasoning and question answering datasets. 
Categories are separated by horizontal rules; results (Exact Match↑ and API/Acc↑) compare zero-shot, agentic, adaptive, procedural, and proposed memory methods. }
\label{tab:single_part}
\end{table*}